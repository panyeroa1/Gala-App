...
import 'create_property_model.dart';
export 'create_property_model.dart';

class CreatePropertyWidget extends StatefulWidget {
  const CreatePropertyWidget({super.key});
...
class _CreatePropertyWidgetState extends State<CreatePropertyWidget>
  ...
  late CreatePropertyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatePropertyModel());
    ...
    _model.pricepernightFocusNode!.addListener(() => safeSetState(() {}));
                                          ...
                                          child: Container(
                                            ...
                                            child: FlutterFlowMediaDisplay(
                                              path: valueOrDefault<String>(
                                                ...
                                                'https://firebasestorage.googleapis.com/v0/b/explore-malaysia-6d28d.appspot.com/o/One%20of%20the%20most%20luxurious%205-stars%20hotel%20in%20the%20world.%20Suite%20and%20the%20best%20view%20in%20Qatar.%20Luxury%20hotel.mp4?alt=media&token=9955e718-382c-433c-86fc-3808b3fd6f58',
                                              ),
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Container(
                                            ...
                                            child: FlutterFlowMediaDisplay(
                                              path:
                                                  'https://cf.bstatic.com/xdata/images/hotel/max1024x768/466040743.jpg?k=26d5ae9df0dbbab7f7528080ae4d8e138cdeb49a9bfefbcfc108508ae87f8c8b&o=&hp=1',
                                              imageBuilder: (path) => ClipRRect(
                                                borderRadius:
                                                    BorderRadius.circular(8.0),
                                                child: CachedNetworkImage(
                                      ...
                                      Align(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            ...
                                            _model.listProperty = PropertyRecord
                                                .getDocumentFromData(
